	...
	<div class="container" style="padding-top: 30px;">
		...
		<div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<div class="media text-muted pt-3">
				...
				<p
					...
					<strong class="d-block text-gray-dark">여야, 손혜원 논란 이어 조해주
						임명 놓고 공방…정국 '꽁꽁'</strong> 한국당, 문대통령 조해주 임명 강행에 의사일정 보이콧 선언
				</p>
			</div>
			<div class="media text-muted pt-3">
				<img
				...
				<p
					class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
					<strong class="d-block text-gray-dark">원시 지구, 행성과 대충돌로 생명체
						원소 받았다</strong> 과연 지구의 생명체는 최초 어떻게 생겨날 수 있었을까?
				</p>
			</div>
			<div class="media text-muted pt-3">
				<img
				...
				<p
					class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
					<strong class="d-block text-gray-dark">'뚱카롱' 열풍…"기형적 마카롱"
						vs "한국적 재해석"</strong> 뚱카롱은 '뚱뚱한 마카롱'을 줄인 신조어. '꼬끄(coque)'라고 부르는 마카롱 껍질 사이에
					필링을 두텁게 채워 넣은 형태를 말한다.
				</p>
			</div>
		...
		<div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<div class="media text-muted pt-3">
				<p
					class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
					<strong class="d-block text-gray-dark">좋아하는 태그</strong> <span>#취업</span>
					<span>#취업</span> <span>#취업</span> <span>#취업</span>
				</p>
			</div>
			<div class="media text-muted pt-3">
				<p
